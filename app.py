...
/* ── Sidebar radio nav ── */
[data-testid="stSidebar"] .stRadio > div { gap: 16px !important; }
...
[data-testid="stSidebar"] .stRadio label:hover { color: #E8E8FF !important; }
...
[data-testid="stSidebar"] .stRadio [aria-checked="true"] div:first-child {
    ...
    box-shadow: 0 0 8px rgba(255,45,120,0.7) !important;
}
