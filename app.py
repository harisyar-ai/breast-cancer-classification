...
/* ── Active nav button via wrapper class ── */
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    <div class='neon-card' style='margin-top:0.2rem;'>
        ...
        <div style='display:flex; flex-direction:column; gap:18px;'>
            ...
            <div style='display:flex; gap:16px; align-items:flex-start;'>
                <div style='background:rgba(57,255,20,0.1); border-radius:50%; width:34px; height:34px; flex    background: var(--bg-dark) !important;
    font-family: 'Inter', sans-serif;
}
...
with st.sidebar:
    ...
    for label, icon in nav_items:
        ...
        marker    = "▶  " if is_active else "    "
        if st.button(f"{icon}  {marker}{label}", key=f"nav_{label}", type=btn_type):
            st.session_state.page = label
            st.rerun()
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    <div class='neon-card'>
        ...
        <a href='https://www.linkedin.com/in/muhammad-haris-afridi' target='_blank'
           style='display:flex; align-items:center; gap:14px; text-decoration:none;
                  padding:12px 14px; background:rgba(10,102,194,0.08);
                  border:1px solid rgba(10,102,194,0.3); border-radius:10px; margin-bottom:10px;'>
            ...
            <div>
                <div style='font-size:0.65rem; color:#6B6B9A; text-transform:uppercase; letter-spacing:0.1em;'>LinkedIn</div>
                <div style='font-size:0.82rem; color:#0A66C2; font-weight:600;'>muhammad-haris-afridi</div>
            </div>
        </a>
        <a href='https://github.com/harisyar-ai' target='_blank'
           style='display:flex; align-items:center; gap:14px; text-decoration:none;
                  padding:12px 14px; background:rgba(191,95,255,0.06);
                  border:1px solid rgba(191,95,255,0.2); border-radius:10px;'>
            <svg xmlns='http://www.w3.org/2000/svg' width='22' height='22' viewBox='0 0 24 24' fill='#BF5FFF'>
            ...
            <div>
                <div style='font-size:0.65rem; color:#6B6B9A; text-transform:uppercase; letter-spacing:0.1em;'>GitHub</div>
                <div style='font-size:0.82rem; color:#BF5FFF; font-weight:600;'>harisyar-ai</div>
            </div>
        </a>
    </div>
    """, unsafe_allow_html=True)
